...
import { Alert, Button, ButtonGroup, Col, Container, Form, InputGroup, Row, Spinner, Table } from "react-bootstrap";
...
const UserProvider = ({ children }) => {
  ...
  return (
    <UserContext.Provider value={{ selectedKey, setSelectedKey, shouldReload, setShouldReload }}>
      {children}
            ...
            <tr key={user._id}>
              ...
              <td>
                <ButtonGroup>
                  ...
                  <Button variant="danger" className="ml-2" onClick={() => handleDelete(user._id)}>
                    Eliminar
                  </Button>
                </ButtonGroup>
              </td>
